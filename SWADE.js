...
SWADE.FEATURES = {
  ...
  'Brawny':
    ...
    'Note=' +
      '"+1 Toughness",' +
      '"+1 Size/+1 Strength step for encumbrance and minimum strength requirements"',
  ...
  'Extra Effort':
    'Section=skill Note="Spend 1 or 3 Power Points to gain +1 or +2 Focus"',
  'Extraction':
  ...
  'Improved Arcane Resistance':
    'Section=attribute Note="Increased Arcane Resistance effects"',
  ...
  'McGyver':
    'Section=skill ' +
    'Note="Successful Repair creates improvised weapon, explosive, or tool"',
  ...
  'Provoke':
    'Section=combat ' +
    'Note="Taunted foe -2 to attack target other than self; joker Action Card ends"',
  'Quick':'Section=combat Note="Redraw Action Card under 6"',
  'Rabble-Rouser':
    'Section=skill Note="Taunt or Intimidate all enemies in 4 yd radius"',
  ...
  'Strong Willed':
    'Section=attribute Note="+2 Smarts and Spirit to resist Tests"',
  ...
  'Weapon Master':'Section=combat Note="+%V Parry/+d%1 damage on Raise"',
...
SWADE.POWERS = {
  ...
  'Blast':
    'Advances=4 ' +
    'PowerPoints=3 ' +
    'Description="R%{smarts*4} yd 4 yd radius inflicts 2d6 (Raise 3d6)"',
  'Blind':
    'Advances=0 ' +
    'PowerPoints=2 ' +
    'Description=' +
  ...
  'Fear':
    ...
    'PowerPoints=2 ' +
    'Description=' +
      '"R%{smarts*2} yd Target extra flees, Wild Card rolls on fear table (Spi neg)"',
  'Fly':
    'Advances=8 ' +
    'PowerPoints=3 ' +
  ...
  'Havoc':
    'Advances=0 ' +
    'PowerPoints=2 ' +
    'Description="R%{smarts*2} yd Throws creatures in 4 yd radius or 18 yd cone 2d6 x 2 yd (Str neg)"',
  'Healing':
    'Advances=0 ' +
    'PowerPoints=3 ' +
  ...
  'Light/Darkness':
    ...
    'PowerPoints=2 ' +
    'Description=' +
      '"R%{smarts*2} yd Creates 6 yd radius bright light or darkness for 10 min"',
  'Mind Link':
    'Advances=0 ' +
    'PowerPoints=1 ' +
    'Description=' +
  ...
  'Sound/Silence':
    ...
    'PowerPoints=1 ' +
    'Description=' +
      '"R%{smarts*10} yd Creates sound up to shout or R%{smarts*2} yd Mutes 6 yd radius for 5 rd"',
  'Speak Language':
    'Advances=0 ' +
    'PowerPoints=1 ' +
...
SWADE.edgeRulesExtra = function(rules, name) {
  ...
  if(name == 'Arcane Background (Gifted)') {
    ...
    rules.defineRule('attributeNotes.arcaneResistance',
      '', '=', '-2',
      'attributeNotes.improvedArcaneResistance', '+', '-2'
    );
